...
@dataclass
class VoyageConfig:
    """Configuration for Voyage AI provider."""
...
class VoyageAdapter(BaseAdapter):
    ...
    async def chat(
        ...
        """Send chat request to Voyage AI API."""
    ...
    async def probe_capabilities(self) -> ModelCapabilities:
        ...
        return ModelCapabilities(
            ...
            supports_tool_calling=False,  # Voyage focuses on embeddings
