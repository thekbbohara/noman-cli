...
DEFAULT_CONTEXT_LIMITS = {
    ...
    "sonar-reasoning-inline": 128000,
    "sonar-pro-online": 128000,
    "sonar-online": 128000,
    "default": 128000,
}
...
class PerplexityAdapter(BaseAdapter):
    ...
    async def probe_capabilities(self) -> ModelCapabilities:
        ...
        return ModelCapabilities(
            ...
            supports_tool_calling=False,  # Perplexity doesn't support tool calling
